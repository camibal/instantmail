        ...
        <form id="form_caja" method="POST">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-7">
              <select class="form-control" id="fkID_tipo_movimiento" name="fkID_tipo_movimiento"required="true">
                <?php $cajaController->getSelectTipoMovimiento();?>
              </select>
            </div>
            <div class="col-sm-2 text-danger">
              *
          ...
          <div class="form-group row">
            <div class="col-sm-12 text-center">
              <button data-accion="crear" type="button" class="btn btn-success" id="btn_guardar_caja">Guardar</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="eliminarModalLabel">Eliminar caja</h5>
      ...
      <div class="modal-footer text-center">
        ...
        <button type="button" class="btn btn-danger" id="btn_eliminar_caja" name="btn_eliminar_caja">Eliminar</button>
