...
$permisos  = $enviosController->Permisos($idUsuario, 7);
?>
<div class="row">
    <div class="col-md-6 text-right">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Mis envios</li>
              </ol>
        </nav>
    </div>
    <div class="col-md-6 text-right">
...
<div class="row">
    ...
    ?>
            ...
            <tbody>
                <?php $enviosController->getTablaEnviosCliente($permisos, $idUsuario);?>
            </tbody>
        </table>
    </div>
</div>
