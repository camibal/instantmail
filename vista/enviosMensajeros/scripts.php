<script type="text/javascript">
  ...
  function marcar_campos(campo, tipo){
    ...
    function edita_envio(){
      ...
      var formElement = document.getElementById("form_envio_mensajeros");
      formData = new FormData(formElement);
      formData.append("tipo", "edita");
      formData.append("archivo", inputFile.files[0]);
      formData.append("fkID_cliente", $("#fkID_cliente").val());
      formData.append("destinatario_envio", $("#destinatario_envio").val());
      formData.append("celular_envio", $("#celular_envio").val());
      formData.append("direccion_envio", $("#direccion_envio").val());
      formData.append("email_envio", $("#email_envio").val());
      formData.append("valor_envio", $("#valor_envio").val());
      formData.append("fkID_mensajero", $("#fkID_mensajero").val());
      formData.append("id_envio", $("#id_envio").val());
    ...
    function evento_editar(){
        ...
        $("[name*='btn_editar']").click(function(){
            ...
            $("#fkID_cliente").attr("disabled","true");
            $("#fkID_mensajero").attr("disabled","true");
            $("#destinatario_envio").attr("disabled","true");
            $("#direccion_envio").attr("disabled","true");
            $("#celular_envio").attr("disabled","true");
            $("#email_envio").attr("disabled","true");
            $("#valor_envio").attr("disabled","true");
        });
    }
