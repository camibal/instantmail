...
?>
<div class="modal fade" id="modalDevolucionesScrollable" tabindex="-1" role="dialog" aria-labelledby="modalDevolucionesScrollableTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalDevolucionesScrollableTitle">Informe de devoluciones</h5>
      ...
      <div class="modal-body">
        <div class="row">
          <div id="tablaDevoluciones" class="w-100">
            ...
            <table class="table table-striped">
              <thead>
                ...
                <tbody id="contenidoDevoluciones">
                  <?php $informes->getTablaDevoluciones('');?>
                  <tr>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-success" id="btn_excel_devoluciones"><i class="fas fa-file-excel"></i></button>
