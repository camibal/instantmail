  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="form_envio_mensajeros" enctype="multipart/form-data">
          <input type="hidden" id="id_envio" name="id_envio">
          <input type="hidden" id="fecha_envio" name="fecha_envio">
          <input type="hidden" id="fkID_cliente" name="fkID_cliente">
          <input type="hidden" id="fkID_mensajero" name="fkID_mensajero">
          <input type="hidden" id="valor_envio" name="valor_envio">
          <div class="form-group row">
            <label for="numero_envio" class="col-sm-3 col-form-label">Número guia:</label>
            <div class="col-sm-7">
              <input type="number" class="form-control" id="numero_envio" name="numero_envio" required="true" style="text-transform:uppercase;">
            </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-7">
              <input type="text" class="form-control" id="destinatario_envio" name="destinatario_envio" required="true">
            </div>
            <div class="col-sm-1 text-danger">
              *
            </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-7">
              <input type="text" class="form-control" id="celular_envio" name="celular_envio" required="true">
            </div>
            <div class="col-sm-1 text-danger">
              *
            </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-7">
              <input type="text" class="form-control" id="direccion_envio" name="direccion_envio" required="true">
            </div>
            <div class="col-sm-1 text-danger">
              *
            </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-7">
              <input type="text" class="form-control" id="email_envio" name="email_envio" required="true">
            </div>
          </div>
          <div class="form-group row">
            <label for="fkID_estado_envio" class="col-sm-3 col-form-label">Estado:</label>
            <div class="col-sm-7">
              <select class="form-control" id="fkID_estado_envio" name="fkID_estado_envio" required="true">
                <?php $enviosController->getSelectEstadoEnvioMensajero();?>
              </select>
            </div>
            <div class="col-sm-1 text-danger">
              *
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-7">
              <textarea class="form-control" placeholder="" id="observaciones_envio" name="observaciones_envio" style="text-transform:uppercase;"></textarea>
            </div>
          </div>
          <div class="form-group row">
            <label for="inputEmail3" class="col-sm-3 col-form-label">Evidencia:</label>
            <div class="col-sm-7">
