...
$permisos  = $enviosController->Permisos($idUsuario, 3);
?>
<div class="row">
    ...
    <div class="col-md-6 text-right">
        ...
        ?>
            <button class="btn btn-success" data-target="#modalEnvio" data-toggle="modal" id="btn_crear_envio" type="button">
                Crear envio
            </button>
        <?php }?>
    </div>
...
<div class="row">
    ...
    ?>
            ...
            <tbody>
                <?php $enviosController->getTablaEnvios($permisos);?>
            </tbody>
        </table>
    </div>
</div>
