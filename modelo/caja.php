...
class Caja
{
    ...
    public function getCaja()
    {
        $query = "SELECT id_movimiento, fecha_movimiento, nombre_tipo_movimiento, valor_movimiento, observaciones_movimiento  FROM movimiento
            ...
            WHERE movimiento.estado = 1 AND (fkID_tipo_movimiento = 1 or fkID_tipo_movimiento = 2)";
        $result = mysqli_query($this->link, $query);
        $data   = array();
        while ($data[] = mysqli_fetch_assoc($result));
        array_pop($data);
    ...
    public function getTipoMovimiento()
    {
        $query  = "SELECT id_tipo_movimiento, nombre_tipo_movimiento FROM tipo_movimiento 
            WHERE estado = 1 AND (id_tipo_movimiento = 1 OR id_tipo_movimiento = 2)
    ...
    public function insertaCaja($data)
    {
    ...
    public function consultaCaja($data)
    {
    ...
    //Edita un movimiento
    public function editaCaja($data)
    {
    ...
    public function eliminaLogicoCaja($data)
    {
